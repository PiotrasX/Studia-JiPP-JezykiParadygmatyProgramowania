...
Compile (F9) and run (F10) silnia.hs or factorial.hs file from the ConTEXT editor.

In the GHCi console, test the invocation of silnia (or factorial) and main functions.
